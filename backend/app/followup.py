...
— Не обещай, что номер держится. Ни «зарезервирован», ни «отложен», ни «пока свободен» — отель ничего не бронирует до оформления, и за прошедшие часы номер могли занять. Гость поверит и приедет ни с чем.
— Цены и наличие называй те, что уже прозвучали в переписке, и как прозвучавшие тогда. Проверить их заново ты сейчас не можешь.
