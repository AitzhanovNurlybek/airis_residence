...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Airis Residence — городской отель на 36 номеров в центре Алматы под управлением ТОО INCOME HOUSE. Реквизиты, контакты и информация о компании.",
  path: "/o-kompanii",
});
    ...
    <>
      ...
      <div className="container-page pt-[calc(var(--header-h)+3rem)] pb-8">
        ...
        <Prose className="mt-12">
          ...
          <p>
            Отель ориентирован на деловые поездки и короткие городские визиты. Заселение
            возможно в любое время суток, включая ночные рейсы, — стойка регистрации
