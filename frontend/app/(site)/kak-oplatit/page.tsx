      ...
      <div className="container-page pt-[calc(var(--header-h)+3rem)] pb-8">
        ...
        <Prose className="mt-12">
          ...
          <p>
            ...
            отмене или незаезде удерживается стоимость первых суток проживания. Возврат
            средств при оплате картой выполняется на ту же карту в срок до 14 рабочих дней.
          </p>
          <p>
