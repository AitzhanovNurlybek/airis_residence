...
export type AdminCorpBooking = {
  ...
  /**
   * Когда бронь занесли в шахматку Exely. null — ещё не занесли.
   *
   * Отдельно от статуса намеренно: статус описывает сделку с компанией, а
   * это — работу отеля внутри Exely. У подтверждённой брони может быть уже
   * выставлен счёт, а в шахматке её всё ещё нет.
   */
  /** Когда подтверждена. В очереди важно, сколько бронь уже ждёт. */
